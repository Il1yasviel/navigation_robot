...
#define ROBOT_MOTOR_QUERY_MS       50
...
#define ROBOT_LEFT_DIRECTION       1
#define ROBOT_RIGHT_DIRECTION      (-1)
#define ROBOT_MOTOR_FEEDBACK_FRESH_MS 500
#define ROBOT_IMU_SAMPLE_PERIOD_MS 10
#define ROBOT_IMU_CALIBRATION_SAMPLES 500
